...
///
typedef enum KYTENSORCLIENT_errorcode_enum {
	KYTENSOR_ERROR_SUCCESS = 0,
	KYTENSOR_ERROR_UNKNOWN,
	KYTENSOR_ERROR_INTERNAL,
	KYTENSOR_ERROR_NOT_FOUND,
	KYTENSOR_ERROR_INVALID_ARG,
	KYTENSOR_ERROR_UNAVAILABLE,
	KYTENSOR_ERROR_UNSUPPORTED,
	KYTENSOR_ERROR_ALREADY_EXISTS,
	KYTENSOR_ERROR_CLOSED,
} KYTENSORCLIENT_Error_Code;

class Error {
    public:
    /// Create an error with the specified message.
    /// \param msg The message for the error
    explicit Error(const std::string& msg = "", KYTENSORCLIENT_Error_Code code =
                    KYTENSOR_ERROR_SUCCESS)
        : msg_(msg), code_(code)
    {
    }
    ...
    KYTENSORCLIENT_Error_Code Code() const { return code_; }
    ...
    void SetStatus(uint8_t status) {
      code_ = (KYTENSORCLIENT_Error_Code)(status & 0x7F);
      switch (code_)
      {
          case KYTENSOR_ERROR_SUCCESS:
              break;
          case KYTENSOR_ERROR_UNKNOWN:
              msg_ = "KYTENSOR_ERROR_UNKNOWN";
              break;
          case KYTENSOR_ERROR_INTERNAL:
              msg_ = "KYTENSOR_ERROR_INTERNAL";
              break;
          case KYTENSOR_ERROR_NOT_FOUND:
              msg_ = "KYTENSOR_ERROR_NOT_FOUND";
              break;
          case KYTENSOR_ERROR_INVALID_ARG:
              msg_ = "KYTENSOR_ERROR_INVALID_ARG";
              break;
          case KYTENSOR_ERROR_UNAVAILABLE:
              msg_ = "KYTENSOR_ERROR_UNAVAILABLE";
              break;
          case KYTENSOR_ERROR_UNSUPPORTED:
              msg_ = "KYTENSOR_ERROR_UNSUPPORTED";
              break;
          case KYTENSOR_ERROR_ALREADY_EXISTS:
              msg_ = "KYTENSOR_ERROR_ALREADY_EXISTS";
              break;
          case KYTENSOR_ERROR_CLOSED:
              msg_ = "KYTENSOR_ERROR_CLOSED";
              break;
    ...
    std::string msg_;
    KYTENSORCLIENT_Error_Code code_;
};
